...
| B-59 | Landing v2 «cinematic»: бараан тансаг загвар, glassmorphism, hero-д хулгана дагадаг 3D parallax картан дээр бодит QR (bil.mn демо линк) + хөвөх SMS/амжилтын мэдэгдлүүд; скроллд өрнөх 3 үзэгдэлт түүх (SMS тархалт → QR төлөлт → eBarimt хэвлэлт, sticky timeline progress-той); амьд тоолуурт статистик + давалгаалах график; micro-interaction (glow товч, pulse, hover lift). framer-motion-оор (three.js-гүй — бандл хөнгөн), prefers-reduced-motion дэмжинэ. Үнэ API-гаас хэвээр | ✅ |
...
| ID | Ажил | Статус |
|---|---|---|
| B-68 | Partner API-ийн B2B баримт ТТД-гээр ажилладаг боллоо: `payer_reg_no`-ийн validation `[0-9]{7,10}` байсан тул 11 оронтой ТТД (ж: 15200020090) «буруу форматтай» гэж унадаг байв — одоо регистр (7 орон), ТТД (11-14 орон), иргэний регистр (АА########) гурвууланг авна. Мөн POS API-ийн `customerTin` заавал ТТД байх ёстой тул регистр ирсэн үед `EbarimtRegistryService.lookup`-аар ТТД болгож хөрвүүлдэг боллоо (нэхэмжлэхийн B2B, month-close-ийн tenant.regNo зам мөн адил ашиг хүртэнэ). Docs/Postman шинэчлэв | ✅ |

## Дууссан (2026-08-19, байгууллагын нэр header-т)

| ID | Ажил | Статус |
|---|---|---|
| B-67 | Нэвтэрсэн хэрэглэгч аль байгууллагын хуудсанд орсноо ил хардаг боллоо: header-т лого хажууд «🏢 Байгууллагын нэр» chip (жижиг дэлгэцэд truncate), sidebar-ийн доод картад мөн нэр; админд «🛡️ Платформ админ» chip. Нэрийг `GET /tenant`-аас татна (админ/партнёрт татахгүй) — backend өөрчлөлтгүй | ✅ |

## Дууссан (2026-08-19, Developers хуудасны баримтжуулалт)

| ID | Ажил | Статус |
|---|---|---|
| B-66 | Developers хуудасны Үйлчилгээ 3 табд «Баримт цуцлах» баримтжуулалт нэмэгдэв: `POST /partner/receipts/:id/cancel` curl + хариу, CANCEL_PENDING/авто-retry тайлбар; Postman collection + docs/API_TESTING.md-д мөн адил. Webhook endpoint хэсэгт «Webhook формат» блок: жишээ илгээлт (`{event, created_at, data}` биет, `X-Billing-Event`/`X-Billing-Signature` толгой), event тус бүрийн data талбарууд, HMAC-SHA256 баталгаажуулалт, retry/at-least-once дүрэм; endpoint нэмэх modal-д event-үүдийн тайлбар + форматын товч санамж, `receipt.cancelled` event сонголтод нэмэгдэв | ✅ |

## Дууссан (2026-08-19, төлбөрийн урсгалын UX)

| ID | Ажил | Статус |
|---|---|---|
| B-65 | Төлбөрийн хуудасны урсгал цөөн товшилттой болов: «Төлбөр төлөх» дармагц Bonum руу ШУУД шилжинэ (дунд «Төлбөрийн хуудас руу шилжих» алхам fallback болж үлдэв); Bonum-аас буцахад (`?r=1` + sessionStorage туг) төлбөрийн товчийг үзүүлэлгүй шууд баталгаажуулалтын горим — 2с тутам түргэн poll (сервер 15с тутам provider-оос бодитоор лавладаг), 20с-ээс удвал «Төлөөгүй — дахин төлөх» сонголт; төлөгдмөгц eBarimt бэлэн болтол авто-шинэчилнэ; тусламжийн утас 72225700. Мөн цуцлалтын үр дүн receipts хуудсанд ил мэдэгдэнэ (амжилттай/дамжуулагдаагүй + шалтгаан) | ✅ |
...
| ID | Ажил | Статус |
|---|---|---|
| B-62 | Dashboard-ийн загвар CallPro Text console-той ижил гэр бүлийн болов (үйлчилгээ нь CallPro мессежийн өргөтгөл тул хэрэглэгчдэд танил): бараан хөх-хар фон, зөөлөн хүрээт бараан картууд, teal акцент/товч, ногоон амжилтын өнгө, бараан sidebar (идэвхтэй цэс teal гэрэлт). Хэрэгжилт: `globals.css`-ийн `.app-dark` scope — (app) layout-ийн wrapper дотор Tailwind утилитуудыг нэг цэгээс дахин будсан тул 30+ хуудсанд гар хүрээгүй; landing/login-д нөлөөгүй. Playwright-аар dashboard + settings screenshot-оор баталгаажуулав | ✅ |

## Дууссан (2026-08-18, онбордингийн UX + ТЕГ lessor API)

| ID | Ажил | Статус |
|---|---|---|
| B-61 | Онбордингийн wizard-д дутуу байсан ЗААВАЛ талбарууд нэмэгдэв: Утас* (1-р алхам, Хаяг* болов), Дансны нэр* (2-р алхам) — өмнө нь wizard-аа дуусгасан ч Bonum/eBarimt хүсэлт ANKET_INCOMPLETE-ээр гацдаг байсан. Мөн ТЕГ-ийн `saveOprLessors` (Түрээслэгч бүртгэх) API холбогдож, Админ → Интеграци → «ТЕГ операторын эрх» хэсэгт «Бүртгэлийн API» сонголт (Борлуулагч/Түрээслэгч/Хоёулаа, default борлуулагч) нэмэгдэв — lessor зам posNo шаарддаггүй | ✅ |

## Дууссан (2026-08-17, партнёрын баримтууд)

| ID | Ажил | Статус |
|---|---|---|
| B-60 | Bonum онбордингийн журам + хариуны загвар (`docs/BONUM_ONBOARDING_SPEC.md`: 3 credential-ийн формат, webhook бүртгэл) ба LIME-ээс шаардах материалын баримт (`docs/LIME_REQUIREMENTS.md`: платформ/мерчант түвшний шаардлага, хариуны загвар) | ✅ |
