...
кэшлэн, Интеграци хуудсанд сонгох цэс болгож үзүүлнэ (жишээ: Архангай `01` +
Чулуут `02` → `0102`). Лавлах татагдаагүй үед талбар нь энгийн текст хэвээр
үлдэж онбординг зогсохгүй.
...
Хоёр зүйлийг чанд баримтална:

* **Зөвхөн өөрийн ТТД-д харьяалагдах POS** санал болгоно — өөр байгууллагын
  `posNo`-г ашиглах нь ТЕГ-ийн журмаар хориотой.
* **Баримт бүрд ганц `posNo`** дамжина. Байгууллагад олон POS (ж: `10025383`,
  `10045952`) байвал UI сонголт болгож үзүүлээд нэгийг нь л хадгална.

Гараар өөр POS сонгосон бол дахин татахад дарж бичихгүй.
...
### ⚠️ `lottery` / `qrData` хадгалалт — шийдвэрлэх шаардлагатай
...
Одоогийн код эдгээрийг `EbarimtReceipt.lottery` / `.qrData` баганад хадгалж,
баримтын хуудсанд эргэж харуулдаг. Энэ нь зааврыг зөрчиж байж болзошгүй.
Сонголтууд:

1. **Хадгалахгүй** — баримт үүсмэгц QR-ийг нэг удаа буцааж харуулаад DB-д
   бичихгүй. Дараа нь эргэж харах боломжгүй болно.
2. **Түр хадгалах** — баримт үүссэнээс хойш N цагийн дараа автоматаар устгах.
3. **Одоогийн хэвээр** — ТЕГ-ээс бичгээр зөвшөөрөл авсны дараа.

Шийдэгдтэл кодыг хөндөөгүй — өөрчлөлт нь баримтын хуудасны зан төлөвийг
өөрчилдөг тул эзний шийдвэр шаардана.
